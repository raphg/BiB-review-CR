...
\begin{center}
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\includegraphics[width=\maxwidth]{figure/data-for-reproducibility} 
\end{knitrout}
...
In the same fashion that experimental protocols need to be published in order for an experiment to be reproduced, computer code and data should also be published along with the results of a data analysis. In order to facilitate exchange and reproducibility, code and data should be standardized as much as possible. 
to embed the R code for complete data analyses in latex documents
% GitHub
% RStudio
% Open Source
